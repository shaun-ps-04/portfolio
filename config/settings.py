...
load_dotenv()  # This loads our .env file
...
ALLOWED_HOSTS = ['localhost', ENV_DOMAIN]
...
# AWS_S3_CUSTOM_DOMAIN = AWS_STORAGE_BUCKET_NAME + '.s3.eu-west-2.amazonaws.com'
...
# TinyMCE
TINYMCE_JS_URL = "js/3rd_party/tinymce_5.10.3/tinymce/tinymce.min.js"
# TINYMCE_JS_URL = os.path.join(STATIC_URL, "js/3rd_party/tinymce_5.10.3/tinymce/tinymce.min.js")
# TINYMCE_JS_ROOT = os.path.join(STATIC_ROOT, "js/3rd_party/tinymce_5.10.3/tinymce")
